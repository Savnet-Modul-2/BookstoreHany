...
//import com.example.bookstore.exceptions.CodeExpirationTimeException;
//import com.example.bookstore.exceptions.EntityAccountNotVerifiedException;
//import com.example.bookstore.exceptions.EntityBadCredentialsException;
//import com.example.bookstore.helper.EmailDetails;
//import com.example.bookstore.helper.PasswordEncryptor;
...
//
//        Assertions.assertThatThrownBy(() -> userService.create(testUser))
...
//    }
    ...
    public void givenWringUserId_FindById_ThrowException() {
        ...
        Assertions.assertThatThrownBy(() -> userService.getById(testUser.getId()))
